...
public class SensorlistFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sensor = new String[] { "Sensor 1", "Test Header 2", "Test Header 3", "Test Header 4" };
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        lv.setAdapter(new ExpandableListAdapter(sensor, children));
    ...
    public class ExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        public ExpandableListAdapter(String[] sensor, String[][] children) {
            this.sensor = sensor;
        ...
        public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = inf.inflate(R.layout.list_sensor_group, parent, false);

                holder = new ViewHolder();
                holder.text = (TextView) convertView.findViewById(R.id.textNamaSensor);
                convertView.setTag(holder);
            } else {
                holder = (ViewHolder) convertView.getTag();
            }
